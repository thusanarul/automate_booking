...
def job_morning(usrname, passwd, email, email_pwd):
    browser = webdriver.Chrome(os.path.join(sys.path[0],"chromedriver"))
    now = datetime.now()
    booking_date = now + timedelta(days=14)
    # "R30", "Sentralbygg 2 S22", "Sentralbygg 2 S23", "Sentralbygg 2 S24", "Elektro E/F EL23"
    rooms = ["360DU1-105" , "322255C", "322260A", "322260B", "341E404"]
    ...
    send_mail(confirmed_room, "08:15-12:00", email, email_pwd)
